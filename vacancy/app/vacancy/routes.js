...
const { getExperinces, createVacancy, getMyVacancies, getVacancy, deleteVacancy, editVacancy, searchVacancy } = require("./controllers");
const passport = require("passport");
const { isManager } = require("../../middlewares/middlewares");
